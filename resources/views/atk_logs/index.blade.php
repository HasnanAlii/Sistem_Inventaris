<x-app-layout>
    ...
    <div class="py-6">
       ...
       <i data-feather="plus" class="w-4 h-4 mr-1"></i> Tambah Pengadaan
    </a> --}}
                    <table class="min-w-[900px] w-full border border-gray-200 divide-y divide-gray-200 text-sm">
                        <thead class="bg-gray-100 text-gray-700 uppercase text-xs">
                            <tr>
                                ...
                                <th class="px-4 py-3 text-left">Tanggal Permintaan</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            @forelse ($logs as $log)
                                <tr class="hover:bg-green-50 transition duration-150">
                                    ...
                                    <td class="px-4 py-3">{{ $log->atk->nama_barang ?? '-' }}</td>
                                    <td class="px-4 py-3">{{ $log->user->name ?? 'Tidak diketahui' }}</td>
