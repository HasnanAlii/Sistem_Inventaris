...
<head>
    <meta charset="UTF-8">
    <title>Surat Daftar Penilaian Aset</title>
    <style>
        body { 
...
<body>
    ...
    <div class="info">
        ...
        <div><strong>Hal:</strong> Laporan Daftar Penilaian Aset</div>
    </div>
    ...
    <p>Dengan hormat,</p>
    <p>Bersama surat ini kami sampaikan laporan hasil penilaian aset yang telah dilakukan oleh tim penilai pada Dinas Arsip dan Perpustakaan Kabupaten Cianjur, dengan rincian sebagai berikut:</p>
        ...
        <tbody>
            @foreach($assessments as $index => $assessment)
                <tr>
                    ...
                    <td>{{ $assessment->usia_bulan }} Bulan</td>
                    <td>{{ $assessment->perbaikan }} Kali</td>
                    <td>{{ $assessment->status }}</td>
                    <td>{{ $assessment->updated_at->format('d F Y') }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
    ...
    <!-- ===== PENUTUP ===== -->
    <div class="footer">
        <p>Demikian laporan daftar penilaian aset ini kami sampaikan. Semoga hasil penilaian ini dapat menjadi bahan evaluasi dan pertimbangan dalam pengelolaan serta perawatan aset di lingkungan Dinas Arsip dan Perpustakaan Kabupaten Cianjur.</p>
